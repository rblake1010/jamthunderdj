...
<div class="aboutwrap">
<div class="about" >
<h1 class="bg-about" id="about"><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="about-thunder">About</h1>
<img src="<?php bloginfo('template_directory'); ?>/DJ1.png" width="458" height="343" class="dj" alt="Richard Blake - Disc Jockey">
<div class="welcome">
<h2>Welcome</h2>
<p>Jam Thunder DJ is a professional mobile entertainment company based out of Virginia Beach,VA providing a unique approach to each event. We offer upscale entertainment for your dream wedding, birthday party or special event. So what are you waiting for? Book your special event now or call us at: <span class="number-about">(757) 495-3412</span> and Let the party begin! Jam Thunder DJ primarily serves the greater Hampton Roads area. </p>
<p>Richard Blake ( DJ Jam Thunder) <br />
Owner / Disc Jockey</p>
</div> <!-- end welcome -->
<div style="clear:both"></div>

<div class="book-wedding">
<h2>Book Your <br /> <span class="bigger space">Wedding</span><span>Now</span></h2>
</div><!-- end christmas -->
...
<div class="mediawrap">
<div class="media" >
<h1 class="bg" id="media"><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="media-thunder">Media</h1>
...
<a class="fancybox-media" href="http://youtu.be/T21Du-W3aWo"><img src="<?php bloginfo('template_directory'); ?>/wedding-clip.png" width="458" alt="Wedding Congo Line" height="289"></a>
...
<a class="fancybox" rel="pic" href="<?php bloginfo('template_directory'); ?>/weddingbig.jpg"><img src="images/pic1.png" width="204" height="128" alt="Groomsmen and Groom Dancing" class="leftpic"></a>
<a class="fancybox" rel="pic" href="<?php bloginfo('template_directory'); ?>/wedding2big.jpg"><img src="images/pic2.png" width="203" height="128" alt="Dancing Wedding" class="rightpic"></a>
<div style="clear:both"></div>
...
<div class="wedding" >
<h1 class="bg" id="wedding"><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="wedding-thunder">Weddings</h1>
<img src="<?php bloginfo('template_directory'); ?>/weddingcouple.png" width="458" alt="Just Married - Jamthunder DJ" height="343" class="dj-hide">

<div class="wedPics">
<img src="<?php bloginfo('template_directory'); ?>/weddingcouple.png" width="458" alt="Just Married - Jamthunder DJ" height="343" class="dj">
<img src="<?php bloginfo('template_directory'); ?>/weddingcouple2.png" width="458" alt="Just Married - Jamthunder DJ" height="343" class="dj">
<img src="<?php bloginfo('template_directory'); ?>/weddingcouple3.png" width="458" alt="Just Married - Jamthunder DJ" height="343" class="dj">
...
<div class="package" >
<h1 class="bg" id="package" ><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="package-thunder">Packages</h1>
<div style="clear:both"></div>
...
<div class="contact">
<h1 class="bg" id="contact" ><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="contact-thunder">Contact</h1>

<div class="contract">
<h2>Contract Information</h2>
<p>The Contract and Event Planner will open in a new window, simply use your browser's print button to print out the Contract or Event Planner, and then email the completed forms to the address on top of the Contract. If there is a problem, please call Richard Blake, Jam Thunder Mobile DJ - at <span class="number-contract">(757) 495-3412</span> to have a Contract and Event Planner for your event mailed or faxed to you.</p>
...
<div class="form-item"><input type="submit" class="submit" value="Submit"></div>
</form>
...
<div class="thanks" >
<h1 class="bg" id="thanks"><img src="<?php bloginfo('template_directory'); ?>/thunder.png" width="31" height="51" class="thanks-thunder">Submitted!</h1>
<div class="packageinfo">
